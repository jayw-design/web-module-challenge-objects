...
// const newItem = Object.create(Object.prototype,
//   {
//     name: {
//       name: "nameName",
//       price: "priceNum",
...
//   price: 18,
//   category: "Lunch",
//   discount: function (banana) {
//     if (banana === "teacher") {
//       return 13.5;
//     } else if (banana === "student") {
//       return 12;
//     } else (banana === "public") {
//       return 16.2;
//     }
...
export const burger = {
  ...
  category: "Lunch",
  discount: function (banana) {
    if (banana === "teacher" || banana === "student") {
      return 18 * 0.75;
    } else {
      return 18 * 0.90;
    }
...
*/
console.log(
  reviews[reviews.length - 1].name = "Ron",
  reviews[reviews.length - 1].rating = "3",
  reviews[reviews.length - 1].feedback = "This place is not bad"
)
...
function getReviewByIndex(arry, num) {
  return `${arry[num].name} gave the restaurant a ${arry[num].rating} star review, and their feedback was: ${arry[num].feedback}`
